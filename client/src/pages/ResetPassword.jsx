...
const ResetPassword = () => {
  ...
  const [isOtpSubmitted, setIsOtpSubitted] = useState(false)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <div className="mb-8 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
        ...
        <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-1 cursor-pointer' >Submit</button>
      </form>
}
